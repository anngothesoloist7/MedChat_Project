...
const translations = {
  en: {
    ...
    'stable': 'Stable',
    'source': 'Source',
    'json_upload': 'Upload Document',
    'upload_error_type': 'Please upload a valid PDF file.',
    'upload_error_format': 'Invalid file format.',
    'file_loaded': 'File Loaded',
    'click_upload': 'Upload your medical documents here',
    'drag_drop': 'or drag and drop',
    'json_hint': 'Just accept PDF format and not over 70 MB',
    'thought_for': 'Thought for',
    'rename': 'Rename',
    'delete': 'Delete',
    'delete_chat_title': 'Delete Chat?',
    'delete_chat_confirm': 'This will delete the prompts, answers, and feedback from your MedChat Activity, as well as any content you created.',
    'cancel': 'Cancel',
  ...
  vi: {
    ...
    'click_upload': 'Tải lên tài liệu y tế của bạn tại đây',
    'drag_drop': 'hoặc kéo và thả',
    'json_hint': 'Chỉ chấp nhận định dạng PDF và không quá 70 MB',
